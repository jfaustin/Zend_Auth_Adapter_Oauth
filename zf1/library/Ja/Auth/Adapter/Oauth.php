...
class Ja_Auth_Adapter_Oauth implements Zend_Auth_Adapter_Interface
{
    /**
     ...
     * @var string
     */
    const DEFAULT_SESSION_NAMESPACE = 'Ja_Auth_Adapter_Oauth';
     ...
     * @return Ja_Auth_Adapter_Oauth Fluent interface
     */
